...
class Map_Obj():
    def __init__(self, width, length, goal_count=1, obs2=0.4, obs_count=-1, obs_radius=-1, water_count=1, water_cost=7, water_radius=-1):
        self.width = width
        self.length = length
    ...
    #Generate obsticles
    def generate_map_mountains_o(self):
